...
From the scatter plots, some variables appeared to have a possible linear relationship with the outputs (for example, X7 and Y1), whilst others had a monotonic relationship (for example, X1 and Y1). Using the Scipy \emph{stats.pearsonr} and \emph{stats.spearmanr} methods, the correlation coefficients were easily calculated, alongside a p-value. 
